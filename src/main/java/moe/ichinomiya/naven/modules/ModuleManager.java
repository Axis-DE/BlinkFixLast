...
public class ModuleManager {
    ...
    private void initModules() {
        // Combat
        registerModule( new Critical(), new Aura(), new KeepSprint(), new AntiBot(), new NoRecoil(), new ShieldHelper(), new RageBot(),
                new ThrowableAimAssist(), new AutoThrow(), new AutoGapple(),new MoreKB());

        // Movement
        registerModule(new AutoClip(), new Sprint(), new Velocity(), new Scaffold(), new ChestAura(), new NoSlow(), new Blink(),
        ...
        // Render
        registerModule(new Notifications(), new DynamicIsland(), new ClickGUIModule(), new ArrayListMod(), new WaterMark(), new NameTags(), new PlayerTags(),
