package axis.shiyan.wei.bluearchive.blinkfix.ui.AltManager.MojangAltManager.microsoft;
...
public final class GuiMicrosoftLogin extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (microsoftLogin == null) {
            fontManager.siyuan18.drawCenteredStringWithShadow(EnumChatFormatting.YELLOW + "Logging in...",width / 2.0f,height / 2.0f - 5f,-1);
        } else {
            fontManager.siyuan18.drawCenteredStringWithShadow(microsoftLogin.getStatus(),width / 2.0f,height / 2.0f - 5f,-1);
        }
    }
