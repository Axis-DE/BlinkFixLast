...
public class SilenceFixWaterMark extends WaterMark {
    ...
    public void render() {
        ...
        String text = "| " + Version.getClientVersion() +  " | User: " + LiveClient.INSTANCE.autoUsername + " | " + Minecraft.getDebugFPS() + "FPS | " + serverIP;
