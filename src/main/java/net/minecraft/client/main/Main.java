...
public class Main {
    public static boolean rawInput = false;
    ...
    public static void main(String[] p_main_0_) {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("BlinkFix" + Minecraft.getSystemTime() % 1000L);
        ...
        rawInput = optionset.has("rawInput");
