...
//        this.displayGuiScreen(new GuiAuthentication());
    ...
    public void shutdownMinecraftApplet() {
        try {
            ...
            BlinkFix.getInstance().onClientShutdown();
...
//            }
    ...
    private void runGameLoop() throws IOException {
        ...
        EventManager eventManager = BlinkFix.getInstance().getEventManager();
        ...
        if (!this.skipRenderWorld) {
            boolean shouldCall = BlinkFix.getInstance() != null && BlinkFix.getInstance().getEventManager() != null;
            if (shouldCall) {
                BlinkFix.getInstance().getEventManager().call(new EventRenderTick(EventType.PRE));
            }
            ...
            if (shouldCall) {
                BlinkFix.getInstance().getEventManager().call(new EventRenderTick(EventType.POST));
            }
        }
    ...
    private void rightClickMouse() {
        OffhandFeatures offhand = (OffhandFeatures) BlinkFix.getInstance().getModuleManager().getModule(OffhandFeatures.class);
        if (offhand.isEnabled()) {
            if (offhand.stack != null && offhand.useItemTicks > 0) {
                return;
            }
        }
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (i != -1) {
                    BlinkFix.getInstance().getEventManager().call(new EventMouseClick(i, Mouse.getEventButtonState()));
                }
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKey() != 0) {
                    BlinkFix.getInstance().getEventManager().call(new EventKey(Keyboard.getEventKey(), Keyboard.getEventKeyState()));
                }
            ...
            BlinkFix.getInstance().getEventManager().call(eventClick);
        ...
        if (BlinkFix.getInstance() != null && BlinkFix.getInstance().getEventManager() != null) {
            BlinkFix.getInstance().getEventManager().call(new EventRunTicks());
        }
    }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (this.theWorld != null) {
            BlinkFix.getInstance().getEventManager().call(new EventWorldUnload());
        }
        ...
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (objectMouseOver.entityHit != null) {
                    BlinkFix.getInstance().getEventManager().call(new EventMiddleClickEntity(objectMouseOver.entityHit));
                }
