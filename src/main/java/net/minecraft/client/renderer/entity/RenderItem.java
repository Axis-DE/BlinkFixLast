...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    public void renderItemOverlays(BaseFontRender fr, ItemStack stack, float xPosition, float yPosition) {
        this.renderItemOverlayIntoGUI(fr, stack, xPosition, yPosition, null);
    }

    public void renderItemOverlayIntoGUI(BaseFontRender fr, ItemStack stack, float xPosition, float yPosition, String text) {
        if (stack != null) {
