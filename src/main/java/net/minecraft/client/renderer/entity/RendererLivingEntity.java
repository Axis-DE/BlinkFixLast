...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            if (Minecraft.getMinecraft().thePlayer == entity) {
                EventRotationAnimation event = new EventRotationAnimation(entity, f, f1, f2, f7, partialTicks, false);
            ...
            EventRendererLivingEntity evt = new EventRendererLivingEntity(EventType.PRE, entity, f6, f5, f8, f2, f7, f, 0.0625f);
            BlinkFix.getInstance().getEventManager().call(evt);
            ...
            if (!evt.isCancelled()) {
                ...
                if (this.renderOutlines) {
                    ...
                    this.renderModel(entity, f6, f5, f8, f2, f7, 0.0625F, evt.isShouldInvisible(), evt.getAlpha());
        ...
        BlinkFix.getInstance().getEventManager().call(new EventRendererLivingEntity(EventType.POST, entity));
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor) {
        renderModel(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor, false, 0.15f);
    }

    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor, boolean forceInvisible, float alpha) {
        boolean flag = !entitylivingbaseIn.isInvisible();
        boolean flag1 = (!flag && !entitylivingbaseIn.isInvisibleToPlayer(Minecraft.getMinecraft().thePlayer)) || forceInvisible;
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (BlinkFix.getInstance().getModuleManager().getModule(NameTags.class).isEnabled() && entity instanceof EntityPlayer) {
            return;
        }
