...
import axis.shiyan.wei.bluearchive.blinkfix.modules.impl.render.*;
...
import axis.shiyan.wei.bluearchive.blinkfix.events.impl.EventMouseOver;
...
import axis.shiyan.wei.bluearchive.blinkfix.modules.impl.combat.NoRecoil;
import axis.shiyan.wei.bluearchive.blinkfix.modules.impl.misc.NoSmoothCamera;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void updateRenderer() {
        ...
        if (BlinkFix.getInstance().getModuleManager() != null) {
            module = BlinkFix.getInstance().getModuleManager().getModule(NoSmoothCamera.class);
        }

        if (this.mc.gameSettings.smoothCamera && (module == null || !module.isEnabled())) {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            Vec3 vec31 = entity.getLook(ViaLoadingBase.getInstance().getTargetVersion().getVersion() > 47 ? 1 : partialTicks);
            ...
            for (Entity entity1 : list) {
                try {
                    if (FriendManager.isFriend(entity1)) {
                        continue;
                    }

                    if (entity1 instanceof EntityOtherPlayerMP && ((EntityOtherPlayerMP) entity1).isFakePlayer()) {
                        continue;
                    }

                    if (Teams.isSameTeam(entity1) && ((Teams) BlinkFix.getInstance().getModuleManager().getModule(Teams.class)).removeHitbox.getCurrentValue()) {
                        continue;
                    }
        ...
        BlinkFix.getInstance().getEventManager().call(new EventMouseOver());
    }
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (BlinkFix.getInstance().getModuleManager().getModule(NoHurtCam.class).isEnabled()) {
            return;
        }
    ...
    public void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                ViewClip module = (ViewClip) BlinkFix.getInstance().getModuleManager().getModule(ViewClip.class);
                for (int i = 0; i < 8; ++i) {
                ...
                if (module.isEnabled()) {
                    d3 *= module.scale.getCurrentValue();
                }
    ...
    public float getNightVisionBrightness(EntityLivingBase entitylivingbaseIn, float partialTicks) {
        FullBright module = (FullBright) BlinkFix.getInstance().getModuleManager().getModule(FullBright.class);
        if (module.isEnabled()) {
            return module.brightness.getCurrentValue();
        }
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (this.mc.inGameHasFocus && flag) {
            NoSmoothCamera module = null;

            if (BlinkFix.getInstance().getModuleManager() != null) {
                module = (NoSmoothCamera) BlinkFix.getInstance().getModuleManager().getModule(NoSmoothCamera.class);
            }

            this.mc.mouseHelper.mouseXYChange();
            float f = this.mc.gameSettings.mouseSensitivity * (mc.gameSettings.smoothCamera && module != null && module.isEnabled() ? module.sensitivity.getCurrentValue() : 1) * 0.6F + 0.2F;
            float f1 = f * f * f * 8.0F;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        // Client
        call3DRenderEvent(partialTicks);
    ...
    // Client
    public void call3DRenderEvent(float renderPartialTicks) {
        GlStateManager.pushMatrix();
        GlStateManager.disableAlpha();
        GlStateManager.enableBlend();
        ...
        BlinkFix.getInstance().getEventManager().call(new EventRender(renderPartialTicks));
    ...
    private void setupFog(int startCoords, float partialTicks) {
        ...
        if (f >= 0.0F) {
            ...
            if (!BlinkFix.getInstance().getModuleManager().getModule(NoLiquidFog.class).isEnabled()) {
                GlStateManager.setFog(2048);
