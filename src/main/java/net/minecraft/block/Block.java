...
public class Block {
    ...
    protected final void setBlockBounds(AxisAlignedBB bb) {
        this.minX = bb.minX;
        this.minY = bb.minY;
        this.minZ = bb.minZ;
        this.maxX = bb.maxX;
    ...
    protected static void addCollisionBoxesToList(BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, AxisAlignedBB blockBox)
    {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (collidingEntity == Minecraft.getMinecraft().thePlayer) {
            EventBondingBoxSet event = new EventBondingBoxSet(this, pos, axisalignedbb);
    ...
    public EnumWorldBlockLayer getBlockLayer() {
        ...
        if (XRay.isXrayEnabled()) {
            return XRay.blockIdList.contains(getIdFromBlock(this)) ? EnumWorldBlockLayer.SOLID : EnumWorldBlockLayer.TRANSLUCENT;
        }
