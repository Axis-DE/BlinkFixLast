...
public class PotionEffect {
    ...
    // Client
    public SmoothAnimationTimer xTimer = new SmoothAnimationTimer(-60, 0.2f);
    public SmoothAnimationTimer durationTimer = new SmoothAnimationTimer(-1, 0.2f);
    public SmoothAnimationTimer yTimer = new SmoothAnimationTimer(-1, 0.2f);
